...
BAND_ENERGY_WEIGHT = 0.005
PEAK_ANCHOR_WEIGHT = 0.005
...
ARMS = [
    ...
    },
    {
        ...
        "paired_time_only_label": "F0_native_time_only",
        "reuse_existing": True,
        "run_root": "runs/f_a2_guard/f_a2b_dist_bande_w005/dual",
    },
    {
        "label": "F-A2d_confScoreInv_w005",
        "branch_mode": "dual",
        "stft_inject_position": "pre_mixer",
        "stft_dist_weight": DIST_WEIGHT,
        "stft_band_energy_weight": BAND_ENERGY_WEIGHT,
        "stft_peak_anchor_weight": 0.0,
        "stft_peak_anchor_sigma_bins": PEAK_ANCHOR_SIGMA_BINS,
        "stft_sample_weight_mode": "waveform_confidence_score_inverse",
        "stft_sample_weight_min": 0.05,
        "paired_f0_label": "F0_native_stft_pre_mixer",
        "paired_time_only_label": "F0_native_time_only",
        "reuse_existing": True,
        "run_root": "runs/f_a2_confidence_guard/f_a2d_confscoreinv_w005/dual",
    },
    {
        "label": "F-A2e_confLevelMedLow_w005",
        "branch_mode": "dual",
        "stft_inject_position": "pre_mixer",
        "stft_dist_weight": DIST_WEIGHT,
        "stft_band_energy_weight": BAND_ENERGY_WEIGHT,
        "stft_peak_anchor_weight": 0.0,
        "stft_peak_anchor_sigma_bins": PEAK_ANCHOR_SIGMA_BINS,
        "stft_sample_weight_mode": "waveform_confidence_level_medlow",
        "stft_sample_weight_min": 0.0,
        "paired_f0_label": "F0_native_stft_pre_mixer",
        "paired_time_only_label": "F0_native_time_only",
        "reuse_existing": True,
        "run_root": "runs/f_a2_confidence_guard/f_a2e_conflevelmedlow_w005/dual",
    },
    {
        "label": "F-A2f_peak_anchor_w005",
        "branch_mode": "dual",
        "stft_inject_position": "pre_mixer",
        "stft_dist_weight": DIST_WEIGHT,
        "stft_band_energy_weight": BAND_ENERGY_WEIGHT,
...
def _run_root(label: str, branch_mode: str) -> str:
    return f"runs/f_a2_peak_anchor/{_slug(label)}/{branch_mode}"
...
def build_run_specs() -> list[dict]:
    """生成 F-A2 peak-anchor probe：复用既有 F-A2 系列，只训练 F-A2f。"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="F-A2 peak-anchor STFT loss guard probe 编排")
    ...
    parser.add_argument("--manifest", default="runs/f_a2_peak_anchor_manifest.csv")
